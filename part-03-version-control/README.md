...
6. **[Recovering from Git disasters](06-recovering-from-git-disasters.md)** — Reflog, dangling commits, accidental force-push, garbage collection: the safety net no one teaches.
